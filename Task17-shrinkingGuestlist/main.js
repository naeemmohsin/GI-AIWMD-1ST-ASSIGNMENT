...
while (dinner_invitation.length > 2) {
    var remove_guest = dinner_invitation.pop();
    console.log("Mr. ".concat(remove_guest, " Sorry, I can't invite you for dinner.\n"));
}
// Two people still on my list, letting them know they’re still invited
for (var i = 0; i < dinner_invitation.length; i++) {
    var message2 = " I am happy to inform you that you are still invited.\n";
    console.log("Mr. ".concat(dinner_invitation[i]).concat(message2));
}
